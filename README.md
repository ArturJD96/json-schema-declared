...
`json-schema-declared` contains JSON Schema metaschemas expressed as Typescript `const` declarations. Those declaration are generated from metaschemas collected at [the official JSON Schema website specification links](https://json-schema.org/specification-links), dereferenced and accessible via Typescript helper types.
...
import type * as d from 'json-schema-declared'
type MySchema = d.Metaschema<'draft-07'>
// -> typeof JSON_SCHEMA_ORG_DRAFT_07_SCHEMA
type SchemaByID = d.Metaschema<'https://json-schema.org/draft-07/schema'>
// -> typeof JSON_SCHEMA_ORG_DRAFT_07_SCHEMA
type KeywordsToCover = d.Keywords<'2020-12'>
// -> "$ref" | "$dynamicAnchor" | "properties" | ...
type TypesToTakeCareFor = d.SimpleTypes<'draft-00'>
// -> "string" | "number" | "integer" | "any" | ...
